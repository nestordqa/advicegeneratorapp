...
__Pagina inicial__: deben armar una landing page con //////////////////OKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKK

- [ ] Alguna imagen de fondo representativa al proyecto
- [ ] Botón para ingresar al home (`Ruta principal`)

__Ruta principal__: debe contener ////////////////OKKKKKKKKKKKKKKKK
...
__Ruta de detalle de videojuego__: debe contener //OKKKKKKKKKKKKKK
...
- [ ] __GET /videogames__: OOOOOOOOOKKKKKKKKKKKKK
  - Obtener un listado de los videojuegos
  - Debe devolver solo los datos necesarios para la ruta principal 
- [ ] __GET /videogames?name="..."__:
  - Obtener un listado de las primeros 15 videojuegos que contengan la palabra ingresada como query parameter
  - Si no existe ningún videojuego mostrar un mensaje adecuado
- [ ] __GET /videogame/{idVideogame}__: OKKKKKKKKKKKKKKKKK
  - Obtener el detalle de un videojuego en particular
  - Debe traer solo los datos pedidos en la ruta de detalle de videojuego
  - Incluir los géneros asociados
- [ ] __POST /videogames__: OOOOOOOOOOKKKKKKKKKKKKKKK
  - Recibe los datos recolectados desde el formulario controlado de la ruta de creación de videojuego por body
  - Crea un videojuego en la base de datos, relacionado a sus géneros.
- [ ] __GET /genres__: OOOOOOOOOOOOKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKK
