...
function validate(obj){
                ...
                if(obj.genre.length <1) error.genre = "Debes ingresar al menos un género";
...
function handleClickGenre(e){
        e.preventDefault();
        setVideogames({
                ...videogames, genre:[...new Set([...videogames.genre, e.target.value])] //Creo un set en el cual se eliminarán valores repetidos, y el resultado del mismo lo encierro en un arreglo.
                }
        )
                ...
                <form onSubmit={(e)=>handleSubmit(e)}>
                        ...
                        <div className="containerForm">
                                ...
                                <div className="formChild">                             
                                        ...
                                        {errores.genre ? <h5>{errores.genre}</h5>:false}                             
                                </div>
